    ...
    <Column gap="lg">
      <CategoryButton.Group>
        <CategoryButton
          ...
          description={
            <Trans>Launch Limyrx Chat when you log into your computer.</Trans>
          }
        >
        ...
        {autostart() &&
          CheckboxButton(
            ...
            t`Limyrx Chat will start in the system tray.`,
          )}
        {CheckboxButton(
          "minimiseToTray",
          "cancel_presentation",
          t`Minimise to Tray`,
          t`Instead of closing, Limyrx Chat will hide in your tray.`,
        )}
        {CheckboxButton(
          "customFrame",
          "web_asset",
          t`Custom window frame`,
          t`Let Limyrx Chat use its own custom titlebar.`,
        )}
      </CategoryButton.Group>
      ...
      <CategoryButton.Group>
        {CheckboxButton(
          ...
          "groups_2",
          t`Discord RPC`,
          t`Rep Limyrx Chat using Discord rich presence.`,
        )}
        {CheckboxButton(
          "spellchecker",
          "spellcheck",
      ...
      <CategoryButton.Group>
        ...
        >
          <Trans>Limyrx Chat for Desktop</Trans>
        </CategoryButton>
      </CategoryButton.Group>
    </Column>
  );
