  ...
  return (
    <>
      <Switch
        fallback={
          <>
            <FlowTitle subtitle={<Trans>Sign into Limyrx Chat</Trans>} emoji="wave">
              <Trans>Welcome!</Trans>
            </FlowTitle>
            <Form onSubmit={performLogin}>
              <Fields fields={["email", "password"]} />
              <Column gap="xl" align>
                <Button variant="text" onPress={() => navigate("/login/reset")}>
                  <Trans>Reset password</Trans>
                </Button>
                <Button variant="text" onPress={() => navigate("/login/resend")}>
                  <Trans>Resend verification</Trans>
                </Button>
              </Column>
              <Row align justify>
                <Button variant="text" onPress={() => navigate("..")}>
