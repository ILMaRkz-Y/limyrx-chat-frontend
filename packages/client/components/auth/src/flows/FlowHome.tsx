...
import Wordmark from "../../../../src/assets/web/wordmark.svg?component-solid";
          ...
          <Column gap="xl">
            ...
            <Column>
              ...
              <span style={{ "text-align": "center", opacity: "0.5" }}>
                <Trans>
                  Limyrx Chat is one of the best ways to stay connected with your
            ...
            <Column>
              <Button onPress={() => navigate("/login/auth")}>
                <Trans>Log In</Trans>
              </Button>
              <Button variant="tonal" onPress={() => navigate("/login/create")}>
                <Trans>Sign Up</Trans>
              </Button>
            </Column>
          </Column>
