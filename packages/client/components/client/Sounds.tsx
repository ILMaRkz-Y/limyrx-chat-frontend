...
import deafenSound from "/assets/sounds/deafen.ogg?url";
import messageSound from "/assets/sounds/message_sound.ogg?url";
import muteSound from "/assets/sounds/mute.ogg?url";
import ringtoneIncomingSound from "/assets/sounds/ringtone_incoming.ogg?url";
import ringtoneOutgoingSound from "/assets/sounds/ringtone_outgoing.ogg?url";
import streamEndSound from "/assets/sounds/stream_end.ogg?url";
import streamStartSound from "/assets/sounds/stream_start.ogg?url";
import streamViewerJoinSound from "/assets/sounds/stream_viewer_join.ogg?url";
import streamViewerLeaveSound from "/assets/sounds/stream_viewer_leave.ogg?url";
import undeafenSound from "/assets/sounds/undeafen.ogg?url";
import unmuteSound from "/assets/sounds/unmute.ogg?url";
import userJoinVoiceSound from "/assets/sounds/user_join_voice.ogg?url";
import userLeaveVoiceSound from "/assets/sounds/user_leave_voice.ogg?url";
import userMovedSound from "/assets/sounds/user_moved.ogg?url";
